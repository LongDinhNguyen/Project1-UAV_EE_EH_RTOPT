...
for prin in range_num_d2d_pairs:
    ...
    for Mon in xrange(max_chan_realizaion):
        ...
        theta_ini = Parameter(value=1/(1-0.9))
        ...
        constraints = []
        c1 = d2d_to_d2d_gains_diag * pow_ >= (exp(rmin * theta_ini.value) - 1) * (d2d_to_d2d_gains_diff * pow_ + 1)
        c2 = 1 / theta_ini.value * pow_ <= (1 - 1 / theta_ini.value) * eta * power_UAV * uav_to_d2d_gains
